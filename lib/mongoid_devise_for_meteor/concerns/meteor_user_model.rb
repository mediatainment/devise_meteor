module MeteorUserModel
  ...
  included do
    ...
    # profile relation
    embeds_one :profile, autobuild: true, class_name: "MeteorProfile"
    embeds_one :services, autobuild: true, class_name: "MeteorService"
  ...
  # maps current email to meteor emails: :address
  ...
  def meteor_map_password
    if (attribute_changed?(:encrypted_password) && encrypted_password.present?) || (encrypted_password.nil? && !sessions.password[:bcrypt].nil?)
